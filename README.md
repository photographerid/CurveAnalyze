...
## Features
- Import standard data from csv file, or input manually
- 4PL and 3PL logistic curve fitting
- Automatic concentration calculation from absorbance values
- Automatic concentration calculation from absorbance in bulk, you can copy from excel column
- Graphical output (standard curve and fitted data points), along with 4PL formula
...
## License
This software is distributed under the MIT License with Academic Citation Requirement.
Please see the LICENSE for details

---

## Citation
If this Software is used to produce results in a scientific publication,  
